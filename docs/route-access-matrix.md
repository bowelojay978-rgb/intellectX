...
| `/admin` | Placeholder, staff-only | Not yet implemented | Runtime guard fails closed unless trusted Clerk claims resolve to `admin`; production RBAC still requires configured and validated claim issuance. | Placeholder route only; must not expose privileged management actions to denied users. | Build coverage, staff route policy/runtime unit tests |
| `/admin/course-review` | Placeholder, staff-only | Not yet implemented | Runtime guard fails closed unless trusted Clerk claims resolve to `admin`; production RBAC still requires configured and validated claim issuance. | Placeholder route only; must not expose review or approval actions to denied users. | Build coverage, staff route policy/runtime unit tests |
...
| `/instructor` | Placeholder, staff-only | Not yet implemented | Runtime guard fails closed unless trusted Clerk claims resolve to `instructor` or `admin`; production RBAC still requires configured and validated claim issuance. | Placeholder route only; must not expose course-management actions to denied users. | Build coverage, staff route policy/runtime unit tests |
| `/instructor/courses` | Placeholder, staff-only | Not yet implemented | Runtime guard fails closed unless trusted Clerk claims resolve to `instructor` or `admin`; production RBAC still requires configured and validated claim issuance. | Placeholder route only; must not expose course-management actions to denied users. | Build coverage, staff route policy/runtime unit tests |
| `/instructor/courses/new` | Placeholder, staff-only | Not yet implemented | Runtime guard fails closed unless trusted Clerk claims resolve to `instructor` or `admin`; production RBAC still requires configured and validated claim issuance. | Placeholder route only; must not expose course creation to denied users. | Build coverage, staff route policy/runtime unit tests |
...
- Admin and instructor placeholder routes now fail closed at runtime unless trusted Clerk session claims contain an allowed staff role. Production workflow readiness still requires claim configuration QA, server authorization, and audit logging.
