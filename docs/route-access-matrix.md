...
| `/admin` | Placeholder, staff-only | Not yet implemented | Staff route policy foundation marks this admin-only, but trusted auth claims and real RBAC enforcement are still missing. | Placeholder route only; must not expose privileged management actions. | Build coverage, staff route policy unit tests |
| `/admin/course-review` | Placeholder, staff-only | Not yet implemented | Staff route policy foundation marks this admin-only, but trusted auth claims and real RBAC enforcement are still missing. | Placeholder route only; must not expose review or approval actions. | Build coverage, staff route policy unit tests |
| `/admin/instructors` | Placeholder, staff-only | Not yet implemented | Staff route policy foundation marks this admin-only, but trusted auth claims and real RBAC enforcement are still missing. | Placeholder route only; must not expose instructor-management actions. | Build coverage, staff route policy unit tests |
| `/instructor` | Placeholder, staff-only | Not yet implemented | Staff route policy foundation allows instructor/admin intent, but trusted auth claims and real RBAC enforcement are still missing. | Placeholder route only; must not expose course-management actions. | Build coverage, staff route policy unit tests |
| `/instructor/courses` | Placeholder, staff-only | Not yet implemented | Staff route policy foundation allows instructor/admin intent, but trusted auth claims and real RBAC enforcement are still missing. | Placeholder route only; must not expose course-management actions. | Build coverage, staff route policy unit tests |
| `/instructor/courses/new` | Placeholder, staff-only | Not yet implemented | Staff route policy foundation allows instructor/admin intent, but trusted auth claims and real RBAC enforcement are still missing. | Placeholder route only; must not expose course creation. | Build coverage, staff route policy unit tests |
...
- Admin and instructor placeholder routes are not production-ready workflows; the staff route policy helper is only a foundation and must not be treated as trusted runtime enforcement until real auth claims, server authorization, and audit logging are implemented.
