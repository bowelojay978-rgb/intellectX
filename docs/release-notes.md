...
- Monitoring, alerting, and incident response are not complete.
- Android release signing is not complete.
...
- Security/env audit documentation.
- Automated legal route checks.
- Automated mobile viewport smoke checks.
- Automated production-route smoke expansion.

Manual QA items remain checklist items until verified by a human tester.
