...
export const metadata: Metadata = {
  ...
  description: "Placeholder instructor course list for future production workflow controls.",
};

export default function InstructorCoursesPage() {
  const metadata = getStaffPlaceholderMetadata("instructor-courses");
      ...
      <PageShell>
        <section className="mx-auto flex max-w-3xl flex-col items-center gap-5 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Button asChild>
              <Link href="/instructor">Back to instructor</Link>
            </Button>
