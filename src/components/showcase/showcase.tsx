...
export function Showcase() {
  return (
    <div className="relative mx-auto mt-12 mb-8 grid w-fit grid-cols-3 gap-8 md:my-24 md:gap-20">
      <Wreath>
        <p className="mb-0.5 text-[0.625rem] md:text-base">Learner Rating</p>
      ...
      <Wreath>
        <p className="text-[0.625rem] md:text-base">Study Plans</p>
        <p className="mt-1.5 text-center text-xs font-bold md:text-2xl">18k created</p>
      </Wreath>
      <Wreath>
        <p className="text-[0.625rem] md:text-base">AI Quizzes</p>
